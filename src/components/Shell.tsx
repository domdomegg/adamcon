...
const Badge = ({count}: {count: number}) => (count > 0
	? (
		<span className='absolute -top-2 right-2 md:static md:ml-1 min-w-[18px] h-[18px] rounded-full bg-brand text-white text-[11px] font-extrabold leading-[18px] text-center px-1 border-2 border-white md:border-0'>
			{count}
		</span>
	)
	: null);
